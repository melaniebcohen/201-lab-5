...
function sumArray(testArray){ //eslint-disable-line
  var initialSum = sum(testArray[0],testArray[1]);
  var totalSum = sum(initialSum[0],testArray[2]);

  var message3 = testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + totalSum[0] + ' is their sum.';
  return [totalSum[0], message3];
}
...
function multiplyArray(testArray){ //eslint-disable-line
  var initialProduct = multiply(testArray[0],testArray[1]);
